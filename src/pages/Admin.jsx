    ...
    <div className="bg-yellow-500 w-full h-[100vh] flex">
      ...
      <div className="two bg-slate-300 w-4/5">
        ...
        {CategoriesApi.map((item) => (
            <div className={`flex min-w-fit w-[20vw] h-36 left-0 top-0  shadow-lg justify-around m-5 p-3 rounded-md transition hover:scale-105 flex-col ${colors[Math.floor(Math.random() * colors.length)]} `}>
        ...
        <div className="flex justify-center w-[20vw] h-36 bg-pink-500 shadow-lg m-5 rounded-md transition hover:scale-105 text-white items-center gap-8 text-2xl font-bold">
