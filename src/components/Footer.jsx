...
const Footer = () => {
  ...
  return (
    <div className="flex bg-yellow-400 border-transparent items-center justify-around p-2 mobile:flex-col mobile:items-start  px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
      <div></div>
